...
function toCelsius(temperatures: number[]): number[] {
  // write your code here...
  const toCelsius = temperatures.map(temperature => (temperature - 32) * (5/9));
  return toCelsius; // replace empty array with what you see is fit
}
...
function hottestDays(temperatures: number[], threshold: number): number[] {
  // write your code here...
  const hottestDays = temperatures.filter(temperature => temperature > threshold);
  return hottestDays; // replace empty array with what you see is fit
}
...
function logHottestDays(temperatures: number[], threshold: number): void {
  // write your code here...
  const hottestDays = temperatures.filter(temperature => temperature > threshold);
  const toCelsius = hottestDays.map(temperature => (temperature - 32) * (5/9));
  toCelsius.forEach(temperature => {
